#!/bin/sh
# https://dev.to/jeffreymfarley/deploy-atomically-with-travis--npm-68b

setup_git() {
  git config --global user.email "donaldaverill@gmail.com"
  git config --global user.name "Donald Averill"
